document.addEventListener("DOMContentLoaded", () => {
    ...
    ScrollTrigger.create({
        ...
        onUpdate: (self) => {
            ...
            const progressPreCard = 1 / totalCards;

            cards.forEach((card, index) => {
                const cardStart = index * progressPreCard;
                let cardProgress = (progress - cardStart) / progressPreCard;
                ...
                if (cardProgress === 1 && index < totalCards - 1) {
                    const remainingProgress =
                        (progress - (cardStart + progressPreCard)) /
                        (1 - (cardStart + progressPreCard));
